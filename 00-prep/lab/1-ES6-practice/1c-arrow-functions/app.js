...
// At first I thought you wanted the constructor function rewritten a well
// Interestingly, this all works as intended, including the greeting

let StudentArrow = (a, b, c) => ({name: a,
   age:b, 
   hometown:c, 
...
//  Arrow functions do not define a this, they look outward in scope to the next this,
//  typically a function containing it, or the window
