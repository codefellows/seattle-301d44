...
console.log(message('Allie'));
 ...
 //broke very nicely with arrow function had to restore to move on -contextual this and arrow func not compatable
...
///when joe scope is invoked the result is the window object. they are not compatable. this keyword does not attatch to the arrow functions.
// 3. Explain why "this" is different when an arrow function is used.
// this wont work with arrow functions ever. it bubbles up to the window object.
// 
