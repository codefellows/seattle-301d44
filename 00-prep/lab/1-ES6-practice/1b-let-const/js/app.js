...
function displayPics(){
  ...
  // Because the 'rando' no longer became defined in displayPics function. And the scope of the console.log('rando'); had nothing to go off of.
  console.log(viewed);
...
function makeChart(){
  ...
  makeChart.defaults.global.defaultFontColor = '#eee';
}
