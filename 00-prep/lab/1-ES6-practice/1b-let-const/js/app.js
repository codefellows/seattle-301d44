...
function displayPics(){
  ...
  // Aaron Response: Rando was defined in a place where the scope of it only existed inside the while loop. It was more specific in scope, so it did not exist specifically where it was asking to access the value of rando.
  console.log(viewed);
